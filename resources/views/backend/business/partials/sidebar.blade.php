<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><span class="brand-logo">
                          <img src="{{asset('images/icon.png')}}" alt=""></span>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i class="fa-solid fa-clock-rotate-left"></i><span class="menu-title text-truncate" data-i18n="Booking History">Booking History</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">5</span></a>
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="app-kanban.html"><i class="fa-solid fa-building"></i><span class="menu-title text-truncate" data-i18n="Company">Company</span></a>
            </li>
            <li class=" nav-item"><a class="d-flex align-items-center" href="app-kanban.html"><i class="fa-solid fa-right-from-bracket"></i><span class="menu-title text-truncate" data-i18n="Logout">Logout</span></a>
            </li>
        </ul>
    </div>
</div>
