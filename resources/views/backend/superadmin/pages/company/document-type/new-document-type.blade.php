                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form" action="{{route('store-new-company-document-type')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-3"></div>
                                        <div class="col-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="content" rows="10" placeholder="Enter Type Detail Here" name="detail"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-3"></div>
                                    </div>
